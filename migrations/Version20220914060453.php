 ...
 */
final class Version20220914060453 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE upgrade_request (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, message LONGTEXT DEFAULT NULL, status VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', deleted_at DATETIME DEFAULT NULL, INDEX IDX_C6C98F7AA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE upgrade_request ADD CONSTRAINT FK_C6C98F7AA76ED395 FOREIGN KEY (user_id) REFERENCES `user` (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE upgrade_request DROP FOREIGN KEY FK_C6C98F7AA76ED395');
        ...
        $this->addSql('DROP TABLE upgrade_request');
